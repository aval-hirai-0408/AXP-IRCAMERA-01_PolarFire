...
/*----------------------------------------------------------------------------*/
/*  GigE Vision reference design MPMC framebuffer include file                */
/*----------------------------------------------------------------------------*/
/*  0.1  | 2011-06-20   |  MM  |  Initial release                             */
/*  0.2  | May 08, 2019 |  MM  |  Add data,timstamp and counter to event      */
/*----------------------------------------------------------------------------*/
/*                                                                            */
/******************************************************************************/
...
// GigE 10Gbps
//================================================================================
#define XPAR_M0_AXI_FB_BASEADDR		(0x90000000)			// Frame Buffer IP


// ---- Gev IP registers --------------------------------------------------
//#define GEV_IP_STREAM_DELAY			(0xc088)
...
//@@@@@#define FRAMEBUF_S_DFO      0x00010000
#define FRAMEBUF_S_RF_OVFLW 0x00020000
//@@@@@#define FRAMEBUF_S_RFO      0x00020000
